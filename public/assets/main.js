...
class EventEmitter
{
    ...
    {
        return instance$9.on(type, listener, options);
    }
    ...
    {
        return instance$9.one(type, listener, options);
    }
    /**
    ...
    {
        return instance$9.off(type, listener, capture);
    }
    /**
    ...
    {
        return instance$9.trigger(type, data);
    }
...
const instance$9 = new EventEmitter();
...
instance$9.mixin(emitter);
emitter.mixin = instance$9.mixin.bind(instance$9);
...
class Router
{
    ...
    static get(path, fn, name, params = [])
    {
        ...
        path.forEach(p => routes$1.add(new Route({ path: p, fn, name, params })));
...
const href = readable(new URL(location.href), set =>
{
...
function create_fragment$8(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(img, "class", "");
			add_location(img, file$7, 6, 4, 151);
			attr_dev(div0, "class", "blured position-absolute start-0 end-0 bottom-0");
			add_location(div0, file$7, 7, 4, 200);
			attr_dev(div1, "class", "background-picture position-absolute top-0 start-0 end-0");
			add_location(div1, file$7, 5, 0, 76);
		},
...
const file$6 = "src\\components\\Heading.svelte";
...
function create_fragment$7(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			span0 = element("span");
			span0.textContent = "Voir la bande annonce";
			t4 = space();
			a1 = element("a");
			i1 = element("i");
			t5 = space();
			span1 = element("span");
			span1.textContent = "Plus d'infos";
			attr_dev(h3, "class", "heading-title text-uppercase mb-3");
			add_location(h3, file$6, 10, 4, 238);
			attr_dev(i0, "class", "bi bi-play-fill");
			add_location(i0, file$6, 20, 12, 540);
			add_location(span0, file$6, 21, 12, 582);
			attr_dev(a0, "href", /*youtube*/ ctx[1]);
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "button-play btn btn-light btn-lg col-12 col-lg-auto");
			add_location(a0, file$6, 15, 8, 388);
			attr_dev(i1, "class", "bi bi-info-circle");
			add_location(i1, file$6, 28, 12, 814);
			add_location(span1, file$6, 29, 12, 858);
			attr_dev(a1, "href", a1_href_value = Router.urlFor("details", { id: /*id*/ ctx[2] }));
			attr_dev(a1, "class", "button-infos btn btn-secondary btn-lg col-12 col-lg-auto ms-lg-3 my-3 my-lg-0");
			add_location(a1, file$6, 24, 8, 639);
			attr_dev(div0, "class", "d-flex flex-column flex-lg-row align-items-center");
			add_location(div0, file$6, 14, 4, 316);
			attr_dev(div1, "class", "heading p-lg-3");
			add_location(div1, file$6, 9, 0, 205);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*id*/ 4 && a1_href_value !== (a1_href_value = Router.urlFor("details", { id: /*id*/ ctx[2] }))) {
...
function instance$7($$self, $$props, $$invalidate) {
	...
	let { titre = "", youtube = "", id = "" } = $$props;
	const writable_props = ['titre', 'youtube', 'id'];
	...
	$$self.$capture_state = () => ({ Router, titre, youtube, id });
	...
	return [titre, youtube, id];
}

class Heading extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$7, create_fragment$7, safe_not_equal, { titre: 0, youtube: 1, id: 2 });
...
function create_fragment$6(ctx) {
	...
	cover = new Cover({
			props: { src: "./assets/pictures/heading.jpg" },
			$$inline: true
		});

	heading = new Heading({ $$inline: true });
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			h1 = element("h1");
			h1.textContent = "C'est la page d'accueil";
			add_location(h1, file$5, 9, 0, 188);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$6($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ Cover, Heading });
	return [];
}
...
/* src\pages\Movies.svelte generated by Svelte v3.59.1 */

const file$4 = "src\\pages\\Movies.svelte";
...
function create_fragment$5(ctx) {
	...
	const block = {
		c: function create() {
			h1 = element("h1");
			h1.textContent = "C'est les films";
			t1 = space();
			a = element("a");
			a.textContent = "Jouer";
			add_location(h1, file$4, 0, 0, 0);
			attr_dev(a, "href", "./game.html");
			add_location(a, file$4, 2, 0, 26);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
const file$3 = "src\\pages\\Tv.svelte";
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			h1 = element("h1");
			h1.textContent = "C'est la TV";
			add_location(h1, file$3, 4, 0, 72);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
/* src\pages\Both.svelte generated by Svelte v3.59.1 */
...
function instance$3($$self, $$props, $$invalidate) {
	let { $$slots: slots = {}, $$scope } = $$props;
	validate_slots('Both', slots, []);
	const writable_props = [];

	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Both> was created with unknown prop '${key}'`);
	});

	$$self.$capture_state = () => ({ Movies, Tv });
	return [];
}

class Both extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			h1 = element("h1");
			h1.textContent = "C'est la page de détails";
...
/* src\pages\Game.svelte generated by Svelte v3.59.1 */
const file$1 = "src\\pages\\Game.svelte";
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			div2 = element("div");
			div0 = element("div");
			div0.textContent = "bonne réponse";
			t2 = space();
			div1 = element("div");
			div1.textContent = "mauvaise réponse";
			t4 = space();
			h1 = element("h1");
			h1.textContent = "Ceci est la page de jeu";
			attr_dev(div0, "class", "notification");
			add_location(div0, file$1, 7, 4, 187);
			attr_dev(div1, "class", "notification");
			add_location(div1, file$1, 8, 4, 237);
			attr_dev(div2, "class", "notify-area position-absolute top-0 start-0 end-0");
			add_location(div2, file$1, 6, 0, 119);
			add_location(h1, file$1, 11, 0, 294);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function create_if_block_3(ctx) {
	let both;
	let current;
	both = new Both({ $$inline: true });

	const block = {
		c: function create() {
			create_component(both.$$.fragment);
		},
		m: function mount(target, anchor) {
			mount_component(both, target, anchor);
			current = true;
		},
		i: function intro(local) {
			if (current) return;
			transition_in(both.$$.fragment, local);
			current = true;
		},
		o: function outro(local) {
			transition_out(both.$$.fragment, local);
			current = false;
		},
		d: function destroy(detaching) {
			destroy_component(both, detaching);
		}
	};
...
function create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(14:0) {#if $route.name === \\\"home\\\"}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*$route*/ ctx[0].name === "home") return 0;
		if (/*$route*/ ctx[0].name === "movies") return 1;
		if (/*$route*/ ctx[0].name === "tv") return 2;
		if (/*$route*/ ctx[0].name === "both") return 3;
		if (/*$route*/ ctx[0].name === "details") return 4;
		if (/*$route*/ ctx[0].name === "game") return 5;
		return 6;
	}
