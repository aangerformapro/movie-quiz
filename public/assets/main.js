...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(i, "class", "bi bi-play-fill");
			add_location(i, file$6, 21, 16, 586);
			add_location(span, file$6, 22, 16, 632);
			attr_dev(a, "href", /*youtube*/ ctx[1]);
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "button-play btn btn-light btn-lg col-12 col-lg-auto");
			add_location(a, file$6, 16, 12, 414);
		},
		m: function mount(target, anchor) {
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(i, "class", "bi bi-info-circle");
			add_location(i, file$6, 30, 16, 918);
			add_location(span, file$6, 31, 16, 966);
			attr_dev(a, "href", a_href_value = Router.urlFor("details", { id: /*id*/ ctx[2] }));
			attr_dev(a, "class", "button-infos btn btn-secondary btn-lg col-12 col-lg-auto ms-lg-3 my-3 my-lg-0");
			add_location(a, file$6, 26, 12, 727);
		},
		m: function mount(target, anchor) {
			insert_dev(target, a, anchor);
			append_dev(a, i);
		...
		p: function update(ctx, dirty) {
			if (dirty & /*id*/ 4 && a_href_value !== (a_href_value = Router.urlFor("details", { id: /*id*/ ctx[2] }))) {
...
function create_fragment$7(ctx) {
	...
	let div0;
	let t2;
	let if_block0 = /*youtube*/ ctx[1] && create_if_block_1$1(ctx);
	let if_block1 = /*id*/ ctx[2] && create_if_block$1(ctx);
